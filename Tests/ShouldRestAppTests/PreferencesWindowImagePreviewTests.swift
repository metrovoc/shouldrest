...
final class PreferencesWindowImagePreviewTests: XCTestCase {
    func testImagePreviewShowsEmptyStateByDefault() throws {
        ...
        XCTAssertEqual(chooseButton.title, "Choose Image…")
        ...
        XCTAssertEqual(clearButton.title, "Clear Image")
    ...
    func testDisabledImageClearButtonExplainsBodyBreakPrerequisite() throws {
        ...
        XCTAssertFalse(chooseButton.isEnabled)
        XCTAssertEqual(chooseButton.toolTip, L10n.tr("prefs.chooseBodyImageDisabledBodyOffHelp"))
        XCTAssertEqual(chooseButton.accessibilityHelp(), L10n.tr("prefs.chooseBodyImageDisabledBodyOffHelp"))
        XCTAssertFalse(clearButton.isEnabled)
