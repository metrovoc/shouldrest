...
final class StatusMenuActionIconTests: XCTestCase {
    func testHighFrequencyMenuActionsHaveSystemSymbols() {
        let expectedSymbols = [
            ...
            "resumeBodyBreak": "play.circle",
            "pauseBodyBreakFor30Minutes": "pause.circle",
            "pauseBodyBreakUntilMorning": "sunrise",
            "pauseBodyBreakIndefinitely": "infinity.circle",
    ...
    func testHighFrequencyMenuActionsHaveBehaviorHelp() {
        ...
        let expectedHelp = [
            ...
            "resumeBodyBreak": L10n.tr("menu.resumeBodyBreakHelp"),
            "pauseFor30Minutes": L10n.tr("menu.pauseDurationHelp"),
            "pauseBodyBreakFor30Minutes": L10n.tr("menu.pauseBodyBreakDurationHelp"),
            "pauseUntilMorning": L10n.tr("menu.pauseUntilMorningHelp"),
            "pauseBodyBreakUntilMorning": L10n.tr("menu.pauseBodyBreakUntilMorningHelp"),
            "pauseIndefinitely": L10n.tr("menu.pauseIndefinitelyHelp"),
            "pauseBodyBreakIndefinitely": L10n.tr("menu.pauseBodyBreakIndefinitelyHelp"),
    ...
    func testSettingsLocationMenuKeepsRawPathOutOfHoverText() throws {
        ...
        XCTAssertEqual(showItem.title, L10n.tr("menu.showSettingsFile"))
        XCTAssertEqual(showItem.title, "Show in Finder")
        XCTAssertFalse(showItem.title.contains("Settings Location"))
        ...
        XCTAssertEqual(copyItem.title, "Copy Location")
        XCTAssertFalse(copyItem.title.contains("Settings Location"))
