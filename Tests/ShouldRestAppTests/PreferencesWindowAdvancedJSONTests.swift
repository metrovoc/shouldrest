...
final class PreferencesWindowAdvancedJSONTests: XCTestCase {
    ...
    func testAdvancedJSONEditorsOfferCopyAndRestoreActions() throws {
        ...
        XCTAssertEqual(appCopy.title, L10n.tr("prefs.copyAppRulesBulkEditor"))
        XCTAssertEqual(appCopy.toolTip, L10n.tr("prefs.copyAppRulesBulkEditorHelp"))
        XCTAssertEqual(appCopy.accessibilityLabel(), L10n.tr("prefs.copyAppRulesBulkEditor"))
        ...
        XCTAssertEqual(ideasCopy.image?.accessibilityDescription, L10n.tr("prefs.copyIdeasBulkEditor"))
        XCTAssertEqual(ideasRestore.title, L10n.tr("prefs.restoreIdeasBulkEditor"))
