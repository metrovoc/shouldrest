...
final class DebugWindowTests: XCTestCase {
    ...
    func testDebugActionsUseIconsAndLocalWindowState() throws {
        ...
        XCTAssertEqual(buttons.openLog.title, "Logs")
        XCTAssertEqual(buttons.openSettings.title, "Settings")
        XCTAssertFalse(buttons.openLog.title.localizedCaseInsensitiveContains("location"))
        XCTAssertFalse(buttons.openSettings.title.localizedCaseInsensitiveContains("finder"))
        ...
        XCTAssertTrue(buttons.openLog.toolTip?.localizedCaseInsensitiveContains("location") ?? false)
        XCTAssertTrue(buttons.openSettings.toolTip?.localizedCaseInsensitiveContains("finder") ?? false)
