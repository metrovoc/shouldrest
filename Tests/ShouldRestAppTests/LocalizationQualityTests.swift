...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testEmergencyCopyUsesInternalConfirmationWithoutCountdownOrExternalWindow() {
        ...
        XCTAssertTrue(L10n.tr("cli.help").contains("Print settings location unless hidden by policy."))
        XCTAssertTrue(L10n.tr("cli.help").contains("Print log location unless hidden by policy."))
        XCTAssertEqual(L10n.tr("cli.settingsPathHidden"), "Settings location is hidden by policy.")
        XCTAssertEqual(L10n.tr("cli.logsPathHidden"), "Log location is hidden by policy.")
        ...
        XCTAssertTrue(L10n.tr("cli.help").contains("输出设置位置，除非策略隐藏"))
        XCTAssertTrue(L10n.tr("cli.help").contains("输出日志位置，除非策略隐藏"))
        XCTAssertEqual(L10n.tr("cli.settingsPathHidden"), "策略已隐藏设置位置。")
        XCTAssertEqual(L10n.tr("cli.logsPathHidden"), "策略已隐藏日志位置。")
