...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testEmergencyCopyUsesInternalConfirmationWithoutCountdownOrExternalWindow() {
        ...
        XCTAssertTrue(L10n.tr("cli.help").contains("Copy support report."))
        XCTAssertTrue(L10n.tr("cli.help").contains("Open the support report window."))
        ...
        XCTAssertTrue(L10n.tr("cli.help").contains("复制支持报告"))
        XCTAssertTrue(L10n.tr("cli.help").contains("打开支持报告窗口"))
