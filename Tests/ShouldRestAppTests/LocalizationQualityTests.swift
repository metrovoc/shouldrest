...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertTrue(englishValues.contains("Cue lead time"))
        XCTAssertTrue(englishValues.contains("How early the pre-rest cue appears before the overlay covers the screen."))
        XCTAssertTrue(englishValues.contains("Use full-screen cue for Eye Gate"))
        XCTAssertTrue(englishValues.contains("Use full-screen cue for Body Break"))
        XCTAssertTrue(englishValues.contains("easier to notice without blocking clicks"))
        XCTAssertTrue(englishValues.contains("Show rest debt indicator"))
        XCTAssertTrue(englishValues.contains("Show a compact menu bar badge and status-menu debt when missed or delayed rests build up."))
        ...
        XCTAssertFalse(englishValues.contains("Show a compact menu bar indicator when missed or delayed rests build rest debt."))
        XCTAssertTrue(englishValues.contains("Body Break in %@"))
        ...
        XCTAssertEqual(L10n.tr("menu.takeEyeGateNow"), "Start Eye Gate")
        XCTAssertEqual(L10n.tr("menu.takeBodyBreakNow"), "Start Body Break")
        XCTAssertEqual(L10n.tr("menu.takeNextScheduledRestNow"), "Start Next Rest")
        XCTAssertEqual(L10n.format("menu.takeNextScheduledRestNowWithKind", "Eye Gate"), "Start Next Eye Gate")
        XCTAssertFalse(englishValues.contains("Start Eye Gate Now"))
        XCTAssertFalse(englishValues.contains("Start Body Break Now"))
        XCTAssertFalse(englishValues.contains("Start Next Rest Now"))
        ...
        XCTAssertTrue(englishValues.contains("queued actions"))
        XCTAssertFalse(englishValues.contains("queued commands"))
        ...
        XCTAssertTrue(simplifiedChineseValues.contains("提示提前时间"))
        XCTAssertTrue(simplifiedChineseValues.contains("护眼休息使用全屏提示效果"))
        XCTAssertTrue(simplifiedChineseValues.contains("活动休息使用全屏提示效果"))
        XCTAssertTrue(simplifiedChineseValues.contains("更容易注意到，但不会阻挡点击"))
        XCTAssertTrue(simplifiedChineseValues.contains("覆盖层遮住屏幕前"))
        XCTAssertTrue(simplifiedChineseValues.contains("显示休息欠账指示器"))
        XCTAssertTrue(simplifiedChineseValues.contains("错过或延后休息累积欠账时，在菜单栏图标显示紧凑角标，并在状态菜单显示欠账。"))
        ...
        XCTAssertTrue(simplifiedChineseValues.contains("排队等待的操作"))
        XCTAssertFalse(simplifiedChineseValues.contains("排队等待的命令"))
        XCTAssertFalse(simplifiedChineseValues.contains("待处理的自动化请求"))

        L10n.languageOverride = "en"
        XCTAssertEqual(L10n.tr("prefs.notificationLead"), "Cue lead time")
        XCTAssertTrue(L10n.tr("prefs.notificationLeadHelp").contains("pre-rest cue"))
        XCTAssertNotEqual(L10n.tr("prefs.notificationLead"), "Lead time")
        ...
        XCTAssertEqual(L10n.tr("prefs.defaultAppExclusionRuleName"), "App rule")
        XCTAssertNotEqual(L10n.tr("prefs.defaultAppExclusionRuleName"), "App Exclusion")
        ...
        XCTAssertTrue(L10n.tr("prefs.customBodyTitlePlaceholder").contains("Optional"))
        XCTAssertTrue(L10n.tr("prefs.customBodyTitlePlaceholder").contains("Body Break idea"))
        XCTAssertTrue(L10n.tr("prefs.customBodyTextPlaceholder").contains("Body Breaks"))
        XCTAssertTrue(L10n.tr("prefs.customBodyTextPlaceholder").contains("movement prompt"))
        ...
        XCTAssertEqual(L10n.tr("prefs.sectionStartup"), "Startup")
        XCTAssertEqual(L10n.tr("prefs.sectionPauseBehavior"), "Pause behavior")
        ...
        XCTAssertTrue(L10n.tr("prefs.pauseUntilMorningLocationHelp").contains("estimate sunrise"))
        ...
        XCTAssertTrue(L10n.tr("prefs.updateFeedURLPlaceholder").hasPrefix("https://"))
        XCTAssertTrue(L10n.tr("prefs.updateFeedURLHelp").contains("looks for new releases"))
        XCTAssertTrue(L10n.tr("prefs.invalidUpdateFeedURL").contains("http:// or https://"))
        XCTAssertEqual(L10n.tr("prefs.showUpdateSource"), "Custom update source")
        XCTAssertEqual(L10n.tr("prefs.hideUpdateSource"), "Hide custom update source")
        XCTAssertTrue(L10n.tr("prefs.updateSourceDisclosureHelp").contains("release location"))
        XCTAssertEqual(L10n.tr("prefs.restoreUpdateSource"), "Restore Default Source")
        XCTAssertTrue(L10n.tr("prefs.restoreUpdateSourceHelp").contains("default GitHub release source"))
        XCTAssertFalse(L10n.tr("prefs.restoreUpdateSource").localizedCaseInsensitiveContains("feed URL"))
        XCTAssertEqual(L10n.format("prefs.numberInputAccessibilityLabel", "Repeat every", "minutes"), "Repeat every, minutes")
        XCTAssertEqual(L10n.tr("prefs.unitAccessibility.minutes"), "minutes")
        XCTAssertEqual(L10n.tr("prefs.unitAccessibility.seconds"), "seconds")
        XCTAssertEqual(L10n.tr("prefs.unitAccessibility.percent"), "percent")
        XCTAssertNotEqual(L10n.tr("prefs.unitAccessibility.minutes"), L10n.tr("prefs.unit.minutes"))
        XCTAssertNotEqual(L10n.tr("prefs.unitAccessibility.seconds"), L10n.tr("prefs.unit.seconds"))
        ...
        XCTAssertTrue(L10n.tr("prefs.preferencesMessagePlaceholder").contains("Team"))
        XCTAssertTrue(L10n.tr("prefs.preferencesMessageHelp").contains("top of Preferences"))
        XCTAssertEqual(L10n.tr("prefs.showAdminControls"), "Show advanced support controls")
        ...
        XCTAssertEqual(L10n.tr("prefs.imagePathHiddenHelp"), "Image location is hidden in Preferences.")
        XCTAssertFalse(L10n.tr("prefs.imagePathHiddenHelp").localizedCaseInsensitiveContains("path"))
        ...
        XCTAssertEqual(L10n.tr("menu.debugPanel"), "Open Support Report…")
        XCTAssertNotEqual(L10n.tr("menu.debugPanel"), "Support Report…")
        XCTAssertTrue(L10n.tr("menu.supportHelp").contains("update checks"))
        XCTAssertTrue(L10n.tr("menu.supportHelp").contains("project links"))
        XCTAssertFalse(L10n.tr("menu.checkUpdatesHelp").localizedCaseInsensitiveContains("github"))
        XCTAssertEqual(L10n.tr("menu.checkUpdatesHelp"), "Check for a newer ShouldRest release.")
        XCTAssertEqual(L10n.tr("menu.settingsFile"), "Settings")
        XCTAssertEqual(L10n.tr("menu.showSettingsFile"), "Show in Finder")
        XCTAssertFalse(L10n.tr("menu.showSettingsFile").contains("Settings Location"))
        XCTAssertEqual(L10n.tr("menu.copySettingsPath"), "Copy Location")
        XCTAssertFalse(L10n.tr("menu.copySettingsPath").contains("Settings Location"))
        XCTAssertTrue(L10n.tr("menu.showSettingsFileHelp").contains("settings location"))
        XCTAssertTrue(L10n.tr("menu.copySettingsPathHelp").contains("settings location"))
        ...
        XCTAssertEqual(L10n.tr("debug.openLog"), "Logs")
        XCTAssertEqual(L10n.tr("debug.openSettings"), "Settings")
        XCTAssertFalse(L10n.tr("debug.openLog").localizedCaseInsensitiveContains("location"))
        XCTAssertFalse(L10n.tr("debug.openSettings").localizedCaseInsensitiveContains("finder"))
        XCTAssertTrue(L10n.tr("debug.openLogHelp").localizedCaseInsensitiveContains("location"))
        XCTAssertTrue(L10n.tr("debug.openSettingsHelp").localizedCaseInsensitiveContains("finder"))
        XCTAssertEqual(L10n.tr("debug.openLogHidden"), "Log Location Hidden")
        XCTAssertEqual(L10n.tr("debug.openSettingsHidden"), "Settings Location Hidden")
        XCTAssertTrue(L10n.tr("debug.openLogHiddenHelp").contains("hidden in Preferences"))
        XCTAssertTrue(L10n.tr("debug.openSettingsHiddenHelp").contains("hidden in Preferences"))
        ...
        XCTAssertTrue(L10n.tr("reset.confirmBody").contains("queued actions"))
        XCTAssertFalse(L10n.tr("menu.resetHelp").contains("queued commands"))
        XCTAssertFalse(L10n.tr("prefs.resetShortcutHelp").contains("queued commands"))
        XCTAssertFalse(L10n.tr("reset.confirmBody").contains("queued commands"))
        ...
        L10n.languageOverride = "zh-Hans"
        XCTAssertEqual(L10n.tr("menu.takeEyeGateNow"), "开始护眼休息")
        XCTAssertEqual(L10n.tr("menu.takeBodyBreakNow"), "开始活动休息")
        XCTAssertEqual(L10n.tr("menu.takeNextScheduledRestNow"), "开始下一项休息")
        XCTAssertEqual(L10n.format("menu.takeNextScheduledRestNowWithKind", "护眼休息"), "开始下一项护眼休息")
        XCTAssertFalse(L10n.tr("menu.takeEyeGateNow").contains("立即"))
        XCTAssertFalse(L10n.tr("menu.takeBodyBreakNow").contains("立即"))
        XCTAssertFalse(L10n.tr("menu.takeNextScheduledRestNow").contains("立即"))
        ...
        XCTAssertEqual(L10n.tr("prefs.defaultAppExclusionRuleName"), "应用规则")
        XCTAssertNotEqual(L10n.tr("prefs.defaultAppExclusionRuleName"), "App Exclusion")
        ...
        XCTAssertNotEqual(L10n.tr("prefs.defaultCustomIdeaTitle"), "Custom Body Break")
        XCTAssertTrue(L10n.tr("prefs.customBodyTitlePlaceholder").contains("可选"))
        XCTAssertTrue(L10n.tr("prefs.customBodyTitlePlaceholder").contains("活动休息提示"))
        XCTAssertTrue(L10n.tr("prefs.customBodyTextPlaceholder").contains("活动休息覆盖层"))
        XCTAssertTrue(L10n.tr("prefs.customBodyTextPlaceholder").contains("走动提示"))
        ...
        XCTAssertEqual(L10n.tr("prefs.sectionStartup"), "启动")
        XCTAssertEqual(L10n.tr("prefs.sectionPauseBehavior"), "暂停行为")
        ...
        XCTAssertEqual(L10n.tr("prefs.notificationLead"), "提示提前时间")
        XCTAssertTrue(L10n.tr("prefs.notificationLeadHelp").contains("休息前提示"))
        XCTAssertNotEqual(L10n.tr("prefs.notificationLead"), "提前时间")
        XCTAssertTrue(L10n.tr("prefs.updateFeedURLPlaceholder").hasPrefix("https://"))
        XCTAssertTrue(L10n.tr("prefs.updateFeedURLHelp").contains("查找新版本"))
        XCTAssertTrue(L10n.tr("prefs.invalidUpdateFeedURL").contains("http:// 或 https://"))
        XCTAssertEqual(L10n.tr("prefs.showUpdateSource"), "自定义更新来源")
        XCTAssertEqual(L10n.tr("prefs.hideUpdateSource"), "隐藏自定义更新来源")
        XCTAssertTrue(L10n.tr("prefs.updateSourceDisclosureHelp").contains("更新位置"))
        XCTAssertEqual(L10n.tr("prefs.restoreUpdateSource"), "恢复默认来源")
        XCTAssertTrue(L10n.tr("prefs.restoreUpdateSourceHelp").contains("默认 GitHub 发布来源"))
        XCTAssertEqual(L10n.format("prefs.numberInputAccessibilityLabel", "每隔", "分钟"), "每隔，分钟")
        XCTAssertEqual(L10n.tr("prefs.unitAccessibility.minutes"), "分钟")
        XCTAssertEqual(L10n.tr("prefs.unitAccessibility.seconds"), "秒")
        XCTAssertEqual(L10n.tr("prefs.unitAccessibility.percent"), "百分比")
        ...
        XCTAssertTrue(L10n.tr("prefs.preferencesMessagePlaceholder").contains("团队"))
        XCTAssertTrue(L10n.tr("prefs.preferencesMessageHelp").contains("偏好窗口顶部"))
        XCTAssertEqual(L10n.tr("prefs.showAdminControls"), "显示高级支持选项")
        ...
        XCTAssertEqual(L10n.tr("prefs.imagePathHiddenHelp"), "图片位置已在偏好设置中隐藏。")
        XCTAssertFalse(L10n.tr("prefs.imagePathHiddenHelp").contains("路径"))
        ...
        XCTAssertEqual(L10n.tr("menu.debugPanel"), "打开支持报告…")
        XCTAssertNotEqual(L10n.tr("menu.debugPanel"), "支持报告…")
        XCTAssertTrue(L10n.tr("menu.supportHelp").contains("更新检查"))
        XCTAssertFalse(L10n.tr("menu.checkUpdatesHelp").localizedCaseInsensitiveContains("github"))
        XCTAssertEqual(L10n.tr("menu.checkUpdatesHelp"), "检查是否有新的 ShouldRest 版本。")
        XCTAssertEqual(L10n.tr("menu.settingsFile"), "设置")
        XCTAssertEqual(L10n.tr("menu.showSettingsFile"), "在 Finder 中显示")
        XCTAssertFalse(L10n.tr("menu.showSettingsFile").contains("设置位置"))
        XCTAssertEqual(L10n.tr("menu.copySettingsPath"), "复制位置")
        XCTAssertFalse(L10n.tr("menu.copySettingsPath").contains("设置位置"))
        XCTAssertTrue(L10n.tr("menu.showSettingsFileHelp").contains("设置位置"))
        XCTAssertTrue(L10n.tr("menu.copySettingsPathHelp").contains("设置位置"))
        ...
        XCTAssertEqual(L10n.tr("debug.openLog"), "日志")
        XCTAssertEqual(L10n.tr("debug.openSettings"), "设置")
        XCTAssertFalse(L10n.tr("debug.openLog").contains("Finder"))
        XCTAssertFalse(L10n.tr("debug.openSettings").contains("位置"))
        XCTAssertTrue(L10n.tr("debug.openLogHelp").contains("Finder"))
        XCTAssertTrue(L10n.tr("debug.openSettingsHelp").contains("位置"))
        XCTAssertEqual(L10n.tr("debug.openLogHidden"), "日志位置已隐藏")
        XCTAssertEqual(L10n.tr("debug.openSettingsHidden"), "设置位置已隐藏")
        XCTAssertTrue(L10n.tr("debug.openLogHiddenHelp").contains("日志位置"))
        XCTAssertTrue(L10n.tr("debug.openSettingsHiddenHelp").contains("设置位置"))
        ...
        XCTAssertFalse(L10n.tr("menu.resetHelp").contains("排队等待的命令"))
        XCTAssertFalse(L10n.tr("prefs.resetShortcutHelp").contains("排队等待的命令"))
        XCTAssertFalse(L10n.tr("reset.confirmBody").contains("排队等待的命令"))
    ...
    func testEmergencyCopyUsesInternalConfirmationWithoutCountdownOrExternalWindow() {
        ...
        XCTAssertTrue(L10n.tr("overlay.emergencyOverrideConfirmHelp").localizedCaseInsensitiveContains("press Esc again"))
        XCTAssertTrue(L10n.tr("overlay.emergencyOverrideConfirmHelp").localizedCaseInsensitiveContains("missed rest"))
        XCTAssertFalse(L10n.tr("overlay.emergencyOverrideConfirmHelp").localizedCaseInsensitiveContains("hold"))
        XCTAssertFalse(L10n.tr("overlay.emergencyOverrideConfirmHelp").localizedCaseInsensitiveContains("another window"))
        ...
        XCTAssertTrue(L10n.tr("prefs.eyeEmergencyOverrideDisabledHelp").localizedCaseInsensitiveContains("quit"))
        XCTAssertTrue(L10n.tr("prefs.eyeEmergencyOverrideDisabledHelp").localizedCaseInsensitiveContains("pause"))
        XCTAssertFalse(L10n.tr("prefs.eyeEmergencyOverrideDisabledHelp").localizedCaseInsensitiveContains("hold"))
        XCTAssertFalse(L10n.tr("prefs.eyeEmergencyOverrideDisabledHelp").localizedCaseInsensitiveContains("another window"))
        ...
        XCTAssertTrue(L10n.tr("overlay.emergencyOverrideConfirmHelp").contains("再次按 Esc"))
        XCTAssertTrue(L10n.tr("overlay.emergencyOverrideConfirmHelp").contains("未完成休息"))
        XCTAssertFalse(L10n.tr("overlay.emergencyOverrideConfirmHelp").contains("长按"))
        XCTAssertFalse(L10n.tr("overlay.emergencyOverrideConfirmHelp").contains("另一个窗口"))
        ...
        XCTAssertTrue(L10n.tr("prefs.eyeEmergencyOverrideDisabledHelp").contains("退出"))
        XCTAssertTrue(L10n.tr("prefs.eyeEmergencyOverrideDisabledHelp").contains("暂停"))
        XCTAssertFalse(L10n.tr("prefs.eyeEmergencyOverrideDisabledHelp").contains("长按"))
        XCTAssertFalse(L10n.tr("prefs.eyeEmergencyOverrideDisabledHelp").contains("按住"))
        XCTAssertFalse(L10n.tr("prefs.eyeEmergencyOverrideDisabledHelp").contains("另一个窗口"))
    ...
    func testBlockedActionNotificationsUseUserActionLanguage() {
        ...
        XCTAssertEqual(L10n.tr("menu.emergencyOverlayOnly"), "Return to Overlay")
        XCTAssertFalse(L10n.tr("menu.emergencyOverlayOnly").localizedCaseInsensitiveContains("Emergency Exit"))
        ...
        XCTAssertEqual(L10n.tr("menu.emergencyOverlayOnly"), "回到覆盖层")
        XCTAssertFalse(L10n.tr("menu.emergencyOverlayOnly").contains("紧急退出"))
