...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertTrue(englishValues.contains("How early the screen-edge cue appears before the overlay covers the screen."))
        ...
        XCTAssertTrue(L10n.tr("prefs.notificationLeadHelp").contains("screen-edge cue"))
        ...
        XCTAssertTrue(L10n.tr("prefs.notificationLeadHelp").contains("屏幕边缘提示"))
