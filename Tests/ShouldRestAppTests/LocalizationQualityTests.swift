...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertTrue(englishValues.contains("Advanced app rule editor"))
        XCTAssertTrue(englishValues.contains("Open Advanced App Rule Editor"))
        XCTAssertTrue(englishValues.contains("Advanced idea editor"))
        XCTAssertTrue(englishValues.contains("Open Advanced Idea Editor"))
        ...
        XCTAssertTrue(simplifiedChineseValues.contains("高级应用规则编辑器"))
        XCTAssertTrue(simplifiedChineseValues.contains("打开高级应用规则编辑器"))
        XCTAssertTrue(simplifiedChineseValues.contains("高级提示编辑器"))
        XCTAssertTrue(simplifiedChineseValues.contains("打开高级提示编辑器"))
        ...
        XCTAssertEqual(L10n.tr("prefs.showAdvancedRules"), "Open Advanced App Rule Editor")
        XCTAssertEqual(L10n.tr("prefs.showAdvancedIdeas"), "Open Advanced Idea Editor")
        ...
        XCTAssertEqual(L10n.tr("prefs.showAdvancedRules"), "打开高级应用规则编辑器")
        XCTAssertEqual(L10n.tr("prefs.showAdvancedIdeas"), "打开高级提示编辑器")
