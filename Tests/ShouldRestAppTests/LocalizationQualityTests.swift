...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertTrue(englishValues.contains("Notification lead time"))
        XCTAssertTrue(englishValues.contains("before the overlay covers the screen"))
        ...
        XCTAssertTrue(simplifiedChineseValues.contains("通知提前时间"))
        ...
        L10n.languageOverride = "en"
        XCTAssertEqual(L10n.tr("prefs.notificationLead"), "Notification lead time")
        XCTAssertTrue(L10n.tr("prefs.notificationLeadHelp").contains("overlay covers the screen"))
        ...
        XCTAssertEqual(L10n.tr("prefs.notificationLead"), "通知提前时间")
        XCTAssertTrue(L10n.tr("prefs.notificationLeadHelp").contains("覆盖层遮住屏幕前"))
