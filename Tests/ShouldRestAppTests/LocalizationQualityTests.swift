...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertTrue(L10n.tr("prefs.contextSummary.appRulesOne").contains("run them only for matched apps"))
        XCTAssertTrue(L10n.tr("prefs.enablePrimaryExclusionHelp").contains("run rests only while matching apps are active"))
        ...
        XCTAssertTrue(L10n.tr("prefs.contextSummary.appRulesOne").contains("只在匹配应用运行时安排休息"))
