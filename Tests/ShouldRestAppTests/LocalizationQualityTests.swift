...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertTrue(englishValues.contains("App rules bulk editor"))
        XCTAssertTrue(englishValues.contains("Bulk Edit App Rules"))
        XCTAssertTrue(englishValues.contains("Ideas bulk editor"))
        XCTAssertTrue(englishValues.contains("Bulk Edit Ideas"))
        XCTAssertTrue(englishValues.contains("Bulk editor needs valid JSON"))
        ...
        XCTAssertTrue(simplifiedChineseValues.contains("应用规则批量编辑器"))
        XCTAssertTrue(simplifiedChineseValues.contains("批量编辑应用规则"))
        XCTAssertTrue(simplifiedChineseValues.contains("提示批量编辑器"))
        XCTAssertTrue(simplifiedChineseValues.contains("批量编辑提示"))
        XCTAssertTrue(simplifiedChineseValues.contains("批量编辑内容需要是有效 JSON"))
        ...
        XCTAssertEqual(L10n.tr("prefs.advancedRulesJSON"), "App rules bulk editor")
        XCTAssertEqual(L10n.tr("prefs.showAdvancedRules"), "Bulk Edit App Rules")
        XCTAssertEqual(L10n.tr("prefs.advancedIdeasJSON"), "Ideas bulk editor")
        XCTAssertEqual(L10n.tr("prefs.showAdvancedIdeas"), "Bulk Edit Ideas")
        XCTAssertEqual(L10n.tr("prefs.invalidJSONTitle"), "Bulk editor needs valid JSON")
        ...
        XCTAssertEqual(L10n.tr("prefs.advancedRulesJSON"), "应用规则批量编辑器")
        XCTAssertEqual(L10n.tr("prefs.showAdvancedRules"), "批量编辑应用规则")
        XCTAssertEqual(L10n.tr("prefs.advancedIdeasJSON"), "提示批量编辑器")
        XCTAssertEqual(L10n.tr("prefs.showAdvancedIdeas"), "批量编辑提示")
        XCTAssertEqual(L10n.tr("prefs.invalidJSONTitle"), "批量编辑内容需要是有效 JSON")
    ...
    func testEmergencyCopyUsesInternalConfirmationWithoutCountdownOrExternalWindow() {
        ...
        XCTAssertTrue(L10n.tr("cli.help").contains("Arm Emergency Exit inside the active Eye Gate overlay."))
        XCTAssertTrue(L10n.tr("cli.requestedEmergency").contains("inside the overlay"))
        XCTAssertTrue(L10n.tr("cli.requestedEmergency").localizedCaseInsensitiveContains("second click"))
        ...
        XCTAssertTrue(L10n.tr("cli.requestedEmergency").contains("再次点击"))
