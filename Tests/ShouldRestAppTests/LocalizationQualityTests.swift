...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertEqual(L10n.tr("menu.settingsFile"), "Settings Location")
        XCTAssertEqual(L10n.tr("menu.showSettingsFile"), "Show Settings Location in Finder")
        XCTAssertNotEqual(L10n.tr("menu.showSettingsFile"), "Show in Finder")
        XCTAssertEqual(L10n.tr("menu.copySettingsPath"), "Copy Settings Location")
        XCTAssertNotEqual(L10n.tr("menu.copySettingsPath"), "Copy Location")
        ...
        XCTAssertEqual(L10n.tr("menu.showSettingsFile"), "在 Finder 中显示设置位置")
        XCTAssertNotEqual(L10n.tr("menu.showSettingsFile"), "在 Finder 中显示")
        XCTAssertEqual(L10n.tr("menu.copySettingsPath"), "复制设置位置")
        XCTAssertNotEqual(L10n.tr("menu.copySettingsPath"), "复制位置")
