...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertTrue(englishValues.contains("Current rest state, settings summary, and support details for troubleshooting."))
        ...
        XCTAssertTrue(simplifiedChineseValues.contains("当前休息状态、设置摘要和支持信息，用于排查问题。"))
        ...
        XCTAssertEqual(L10n.tr("debug.openLog"), "Show Log Location")
        XCTAssertEqual(L10n.tr("debug.openSettings"), "Show Settings Location")
        ...
        XCTAssertEqual(L10n.tr("debug.openLog"), "显示日志位置")
        XCTAssertEqual(L10n.tr("debug.openSettings"), "显示设置位置")
    ...
    func testEmergencyCopyUsesInternalConfirmationWithoutCountdownOrExternalWindow() {
        ...
        XCTAssertTrue(L10n.tr("cli.help").contains("Copy diagnostics."))
        XCTAssertTrue(L10n.tr("cli.help").contains("Open the diagnostics window."))
        ...
        XCTAssertEqual(L10n.tr("cli.requestedDiagnostics"), "Requested diagnostics copy.")
        XCTAssertEqual(L10n.tr("cli.requestedDiagnosticsWindow"), "Requested diagnostics window.")
        ...
        XCTAssertTrue(L10n.tr("cli.help").contains("复制诊断信息"))
        XCTAssertTrue(L10n.tr("cli.help").contains("打开诊断窗口"))
        ...
        XCTAssertEqual(L10n.tr("cli.requestedDiagnostics"), "已请求复制诊断信息。")
        XCTAssertEqual(L10n.tr("cli.requestedDiagnosticsWindow"), "已请求打开诊断窗口。")
