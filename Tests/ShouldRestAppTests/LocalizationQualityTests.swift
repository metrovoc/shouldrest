...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertTrue(englishValues.contains("Bulk editor content has an invalid format"))
        ...
        XCTAssertEqual(L10n.tr("prefs.invalidJSONTitle"), "Bulk editor content has an invalid format")
