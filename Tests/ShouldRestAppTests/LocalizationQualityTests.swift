...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertTrue(englishValues.contains("App rules JSON"))
        XCTAssertTrue(englishValues.contains("Bulk Edit App Rules"))
        XCTAssertTrue(englishValues.contains("Ideas JSON"))
        ...
        XCTAssertTrue(simplifiedChineseValues.contains("应用规则 JSON"))
        XCTAssertTrue(simplifiedChineseValues.contains("批量编辑应用规则"))
        XCTAssertTrue(simplifiedChineseValues.contains("提示 JSON"))
        ...
        XCTAssertEqual(L10n.tr("prefs.advancedRulesJSON"), "App rules JSON")
        XCTAssertEqual(L10n.tr("prefs.showAdvancedRules"), "Bulk Edit App Rules")
        XCTAssertEqual(L10n.tr("prefs.advancedIdeasJSON"), "Ideas JSON")
        ...
        XCTAssertEqual(L10n.tr("prefs.advancedRulesJSON"), "应用规则 JSON")
        XCTAssertEqual(L10n.tr("prefs.showAdvancedRules"), "批量编辑应用规则")
        XCTAssertEqual(L10n.tr("prefs.advancedIdeasJSON"), "提示 JSON")
