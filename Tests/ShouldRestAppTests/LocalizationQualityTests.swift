...
final class LocalizationQualityTests: XCTestCase {
    ...
    func testVisiblePreferenceCopyAvoidsImplementationTerms() throws {
        ...
        XCTAssertEqual(L10n.tr("prefs.matchTermsPlaceholder"), "Zoom, Keynote, or app identifier")
        ...
        XCTAssertEqual(L10n.tr("prefs.matchTermsPlaceholder"), "Zoom、Keynote 或应用标识")
