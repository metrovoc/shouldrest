...
final class PreferencesWindowAutosaveStatusTests: XCTestCase {
    ...
    func testAutosaveReadyCopyUsesSavedStateInEnglishAndChinese() {
        ...
        XCTAssertEqual(L10n.tr("prefs.autosaveAppRuleAdded"), "App rule added")
        XCTAssertEqual(L10n.tr("prefs.autosaveAppRuleUpdated"), "App rule updated")
        XCTAssertEqual(L10n.tr("prefs.autosaveAppRuleRemoved"), "App rule removed")
        XCTAssertEqual(L10n.tr("prefs.autosaveCustomIdeaAdded"), "Body Break idea added")
        XCTAssertEqual(L10n.tr("prefs.autosaveCustomIdeaUpdated"), "Body Break idea updated")
        XCTAssertEqual(L10n.tr("prefs.autosaveCustomIdeaRemoved"), "Body Break idea removed")
        XCTAssertEqual(L10n.tr("prefs.autosaveShortcutSet"), "Shortcut set")
        ...
        XCTAssertEqual(
            L10n.tr("prefs.autosaveMenuBarHidden"),
        ...
        XCTAssertEqual(L10n.tr("prefs.autosaveAppRuleAdded"), "应用规则已添加")
        XCTAssertEqual(L10n.tr("prefs.autosaveAppRuleUpdated"), "应用规则已更新")
        XCTAssertEqual(L10n.tr("prefs.autosaveAppRuleRemoved"), "应用规则已移除")
        XCTAssertEqual(L10n.tr("prefs.autosaveCustomIdeaAdded"), "活动休息提示已添加")
        XCTAssertEqual(L10n.tr("prefs.autosaveCustomIdeaUpdated"), "活动休息提示已更新")
        XCTAssertEqual(L10n.tr("prefs.autosaveCustomIdeaRemoved"), "活动休息提示已移除")
        XCTAssertEqual(L10n.tr("prefs.autosaveShortcutSet"), "快捷键已设置")
